...
var Grid = (function() {
	...
	Preview.prototype = {
		create : function() {
			...
			this.$title = $( '<h2></h2>');
			this.$price = $( '<h1></h1>');
			this.$price_medium = $( '<h1></h1>');
			this.$price_large = $( '<h1></h1>');
			this.$size = $( '<h1></h1>');
			this.$size_medium = $( '<h1></h1>');
			this.$size_large = $( '<h1></h1>');
			this.$copywrite = $( '<h1></h1>');
			this.$description = $('<h2></h2>');
			this.$image_category = $('<h4></h4>');
			this.$dimension_small = $('<h3></h3>');
		...
		update : function( $item ) {
			...
			var $itemEl = this.$item.children( 'a' ),
				eldata = {
					...
					dimension_medium : $itemEl.data( 'dimension_medium' ),
					...
					size_medium : $itemEl.data( 'size_medium' ),
					size_large : $itemEl.data( 'size_large' ),
					copywrite : $itemEl.data( 'copywrite' ),
				};

			this.$title.html( eldata.title );
			this.$dimension_small.html( eldata.dimension_small );
			...
			this.$price_large.html( eldata.price_large );
			this.$size.html( eldata.size );
			this.$size_medium.html( eldata.size_medium );
			this.$size_large.html( eldata.size_large );
			this.$copywrite.html( eldata.copywrite );
