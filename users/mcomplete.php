  ...
  <body>
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        ...
        <div class="container">
          <div class="row">
            <h1><strong><?php echo $user->data()->name; ?></strong>, finalizing your profile &raquo;</h1>
          </div>
          <br><br>
          <div class="row smpl-step" style="border-bottom: 0; min-width: 500px;">
            ...
            <div class="col-xs-3 smpl-step-step complete">
              ...
              <a class="smpl-step-icon"><i class="fa fa-check" style="font-size: 55px; padding-left: 5px; padding-top: 10px; color: #fff;"></i></a>
              <div class="smpl-step-info text-center">Model chosen</div>
            </div>
            <div class="col-xs-3 smpl-step-step disabled">
              ...
              <div class="smpl-step-info text-center">Client need this to hire you</div>
            </div>
            <!--  <div class="col-xs-3 smpl-step-step disabled">           
          ...
          <div class="row">
            <aside>
              <form action="" method="post">
                <label class="lsn">*Phone Number</label><br><input name="phone" value="<?php echo escape(Input::get('phone'));?>" class="sn" placeholder="Contact " type="text">
                <br>
                <label class="lsn">*Country</label><br><input type="text" class="sn" value="<?php echo escape(Input::get('country'));?>" name="country" placeholder="Country " >
                <br>
                ...
                <label class="lsn" >*Height</label><br>
                <input type="number" name="height" value="<?php echo escape(Input::get('height'));?>" class="sn" placeholder="Height">
                <br>
                <label class="lsn" >*Weight</label><br>
                <input type="number" name="weight" class="sn" value="<?php echo escape(Input::get('weight'));?>" placeholder="Weight"><br>
                <label class="lsn" >*Twitter</label><br>
                <input type="text" name="twitter" class="sn" value="<?php echo escape(Input::get('twitter'));?>" placeholder="www.twitter.com/username"><br>   
            ...
            <aside class="right">
                ...
                <label class="lsn" >*City</label><br>
                <input type="text" name="city" class="sn" value="<?php echo escape(Input::get('city'));?>" placeholder="City of Residence">
                <br>
                <label class="lsn" >*Bust</label><br>
                <input type="number" name="bust" class="sn" value="<?php echo escape(Input::get('bust'));?>"placeholder="Bust">
                <br>
                <label class="lsn" >*Waist</label><br>
                <input type="number" name="waist" class="sn" value="<?php echo escape(Input::get('waist'));?>" placeholder="Waist"><br>
                <label class="lsn" >*Eye colour</label><br>
                <input type="text" name="eye" class="sn" value="<?php echo escape(Input::get('eye'));?>" placeholder="Eye colour"><br>
                <label class="lsn" >*Shoe size</label><br>
                <input type="number" name="shoe" class="sn" value="<?php echo escape(Input::get('shoe'));?>" placeholder="Shoe size"><br><br>
