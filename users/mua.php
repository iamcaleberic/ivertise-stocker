  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      $("#upload").click(function(){
          $("#dynamic").load("load/uploadmua.php");
      });
      });
    </script>
  </head>
  <body>
    ...
    <section id="main-content">
      <section class="wrapper site-min-height"  id="dynamic">
        ...
        <h1>Make-up Artists Dashboard</h1>
        <div class="container">
        ...
        <div class="row mt gallery js-flickity" data-flickity-options='{ "wrapAround": true ,"imagesLoaded": true,  "pageDots": false, "autoPlay": true}'>
          <?php
            $img = DB::getInstance()->query("SELECT * FROM images WHERE author = '$email' AND genre='mua' ");
            if (!$img->count()) {
