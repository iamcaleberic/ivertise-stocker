...
<aside>
          <div id="sidebar"  class="nav-collapse " style="padding-top:20px;">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <p class="centered"><a href="profile.html"><img src="<?php echo $user->data()->avatar; ?>" class="img-circle" width="50%"></a></p>
...
<div class="row mt gallery js-flickity" data-flickity-options='{ "wrapAround": true ,"imagesLoaded": true,  "pageDots": false, "autoPlay": true}'>
  <div class="gallery-cell col-lg-4 col-md-4 col-sm-4 col-xs-12 desc">
    <div class="project-wrapper">
                <div class="project">
                    <div class="photo-wrapper">
                        <div class="photo">
                          <a class="fancybox" href="<?php echo $user->data()->avatar; ?>"><img class="img-responsive" src="<?php echo $user->data()->avatar; ?>" alt=""></a>
                        </div>
