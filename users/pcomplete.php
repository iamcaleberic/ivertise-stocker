  ...
  <body>
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        ...
        <div class="container">
          <div class="row">
            <h1><strong><?php echo $user->data()->name; ?></strong> photography profile &raquo;</h1>
          </div>
          <br><br>
          ...
          <aside class="right">
              ...
              <input type="hidden" name="photography" value="photographer">
