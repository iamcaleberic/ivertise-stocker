...
<aside>
          <div id="sidebar"  class="nav-collapse " style="padding-top:20px;">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <p class="centered"><a href="profile.html"><img src="<?php echo $user->data()->avatar; ?>" class="img-circle" width="60"></a></p>
                  <h5 class="centered"><a href="display.php?user=<?php echo $user->data()->username; ?>"> <i class="fa fa-user"> <?php echo $user->data()->name; ?></i></a> </h5>
            ...
            <div class="row coralbg white">
                <div class="col-md-6 no-pad">
                    <div class="user-pad">
                        ...
                        <h4 class="white"><i class="fa fa-location-arrow"></i> <?php echo $user->data()->city; ?>, <?php echo $user->data()->country; ?></h4>
                        <h4 class="white"><i class="fa fa-twitter"></i> <?php echo $user->data()->twitter; ?></h4>
                        <button type="button" class="btn btn-labeled btn-info" href="#">
                            <span class="btn-label"><i class="fa fa-upload"></i></span>Upload Photos</button>
                    </div>
                </div>
                <div class="col-md-6 no-pad">
                    <div class="user-image">
                        <img src="<?php echo $user->data()->avatar; ?>" class="img-responsive thumbnail">
                    </div>
                </div>
            </div>
            <div class="row overview">
                <div class="col-md-4 user-pad text-center">
                    <h3><i class="fa fa-upload"> Uploads</i></h3>
                    <h4>0</h4>
                </div>
                <div class="col-md-4 user-pad text-center">
                    <h3><i class="fa fa-download"> Downloads</i></h3>
                    <h4>1</h4>
                </div>
                <div class="col-md-4 user-pad text-center">
                    <h3><i class="fa fa-thumbs-o-up"> Likes</i></h3>
                    <h4>1</h4>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="view">
                            ...
                            <img src="<?php echo $user->data()->avatar; ?>" class="img-responsive">
                        </div>
                        <div class="info">
